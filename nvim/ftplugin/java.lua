...
local root_files = {
  '.git',
  -- Adicione os ficheiros de build que usa no seu projeto (ex: Gradle e Maven)
  'mvnw',
  'gradlew',
  'pom.xml',
  'build.gradle',
...
local function get_jdtls_paths()
  ...
  path.runtimes = {
    ...
    -- This example assume you are using sdkman: https://sdkman.io
     {
       name = 'javase-1.8',
       path = vim.fn.expand('~/.sdkman/candidates/java/8.0.462-tem'),
     },
     {
       name = 'javase-17',
...
local function jdtls_setup(event)
 ...
 -- INÍCIO DA CORREÇÃO DE SSL/REDE
    '--add-opens',
    'java.base/sun.security.ssl=ALL-UNNAMED',
    '-Djdk.tls.client.protocols=TLSv1.2,TLSv1.3',
    -- FIM DA CORREÇÃO DE SSL/REDE   
	-- Proxy caso utilize uma rede corporativa
--	'-Dhttp.proxyHost=SEU_PROXY_HOST',
--  '-Dhttp.proxyPort=SEU_PROXY_PORT',
    -- 💀
    '-jar',
    path.launcher_jar,
